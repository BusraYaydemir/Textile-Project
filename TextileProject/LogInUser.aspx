<%@ Page Title="" Language="C#" MasterPageFile="~/Default.Master" AutoEventWireup="true" CodeBehind="LogInUser.aspx.cs" Inherits="TextileProject.LogInUser" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">

    <section id="specialLogin" class="specialLogin">
        <h1 class="heading">USER <span>LOG IN</span></h1>
