    ...
    public partial class LogInUser : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (user != null)
            {
                ...
                string query1 = "SELECT Company FROM [User] WHERE Name = @name";
                ...
                {
                    lblResult.Text = "User Company not found.";
                }
        ...
        protected void btnLogIn_Click(object sender, EventArgs e)
        {
            ...
            if (dr.Read())
            {
                ...
                lblResult.Text = "User Login Successfull.";
            }
            else
            {
                lblResult.Text = "User Login Failed.";
            }
