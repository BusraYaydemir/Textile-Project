<%@ Page Title="" Language="C#" MasterPageFile="~/Default.Master" AutoEventWireup="true" CodeBehind="LogInVendor.aspx.cs" Inherits="TextileProject.LogInVendor" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">

    <section id="specialLogin" class="specialLogin">
        <h1 class="heading">VENDOR <span>LOG IN</span></h1>
